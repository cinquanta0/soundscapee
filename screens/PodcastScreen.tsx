...
function createPmStyles(colors: ThemeColors) { return StyleSheet.create({
  ...
  pickBtnTxt: { color: C.accent, fontSize: 14 },
  actions: { flexDirection: 'row', gap: 10, marginTop: S.xl },
  cancelBtn: { flex: 1, padding: 14, borderRadius: R.sm, backgroundColor: colors.bgInput, borderWidth: 1, borderColor: colors.border, alignItems: 'center' },
  cancelTxt: { color: colors.textSecondary, fontSize: 14 },
  publishBtn: { flex: 1, padding: 14, borderRadius: R.sm, backgroundColor: C.accent, alignItems: 'center' },
  publishTxt: { color: C.textOnAccent, fontSize: 14, fontWeight: '700' },
  coverRow: { flexDirection: 'row', gap: S.md, alignItems: 'flex-start', marginBottom: S.xs },
  coverThumb: { width: 72, height: 72, borderRadius: R.sm },
  coverThumbEmpty: { backgroundColor: C.bgCard, borderWidth: 1, borderColor: C.border, alignItems: 'center', justifyContent: 'center' },
  coverBtns: { flex: 1 },
  tutorialHighlight: {
    borderRadius: R.sm,
    borderWidth: 1.5,
