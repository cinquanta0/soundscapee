...
function createBubbleStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    checkRead: { color: colors.textAccent },
...
function createChatScreenStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    backTxt: { color: colors.textAccent, fontSize: 28, fontWeight: '300', lineHeight: 32 },
    ...
    replyBarTitle: { color: colors.textAccent, fontSize: 11, fontWeight: '700', marginBottom: 2 },
    ...
    scrollDownTxt: { color: colors.textAccent, fontSize: 18, fontWeight: '700', lineHeight: 22 },
