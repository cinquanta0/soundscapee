...
function createStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    headerLabel: {
      fontSize: 12, color: colors.textMuted, letterSpacing: 2, fontWeight: '600',
    },

    scroll: { paddingBottom: 48 },
    divider: { height: 1, backgroundColor: colors.border, marginHorizontal: 24, marginVertical: 4 },

    // Sezione testo
    section: { paddingHorizontal: 24, paddingVertical: 16, gap: 8 },
    sectionLabel: { fontSize: 11, color: colors.textMuted, letterSpacing: 1.5, fontWeight: '600' },
    ...
    categoryTxt: { fontSize: 11, color: colors.textSecondary },
    ...
    modalHandle: {
      ...
      backgroundColor: colors.borderSubtle, alignSelf: 'center', marginBottom: 4,
    },
    ...
    playlistRowName: { flex: 1, fontSize: 14, color: colors.text, fontWeight: '500' },
    playlistRowCount: { fontSize: 11, color: colors.textMuted },
    separator: { height: 1, backgroundColor: colors.border },

    noPlaylistsTxt: { fontSize: 13, color: colors.textMuted, textAlign: 'center', paddingVertical: 16 },
    ...
    modalCloseTxt: { color: colors.textMuted, fontSize: 14 },
  });
}
