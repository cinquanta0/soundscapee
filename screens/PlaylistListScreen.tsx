...
function createStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    headerTitle: { fontSize: 20, fontWeight: '700', color: colors.text, fontStyle: 'italic' },
    newBtn: {
    ...
    emptyTxt: { fontSize: 15, color: colors.textMuted, textAlign: 'center', lineHeight: 22 },
    ...
    rowCount: { fontSize: 11, color: colors.textMuted, fontFamily: 'monospace' },
    deleteBtn: { padding: 4 },
    ...
    modalCancelTxt: { color: colors.textSecondary, fontSize: 14, fontWeight: '600' },
    modalConfirmBtn: {
      flex: 1, paddingVertical: 11, borderRadius: 10,
