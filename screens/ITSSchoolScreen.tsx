...
const s = StyleSheet.create({
  ...
  audioModeTxt: { color: C.textMute, fontSize: 12, fontWeight: '700' },
  audioModeTxtActive: { color: C.gold },
  recordSection: {
    alignItems: 'center',
    gap: 12,
    paddingVertical: 12,
  ...
  recordTime: { color: C.textDim, fontSize: 14, fontWeight: '700' },
  recordBtn: {
    width: 84,
    height: 84,
    borderRadius: 42,
