...
import {
  ...
  Dimensions, StyleSheet, StatusBar, TouchableWithoutFeedback,
} from 'react-native';
...
export default function StoryViewer({ groups, startGroupIndex = 0, visible, onClose, onViewed }: Props) {
